...
var AddonModForumIndexPage = /** @class */ (function () {
    ...
    AddonModForumIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-forum-index',template:/*ion-inline-start:"/var/www/html/apps/bajajauto/src/addon/mod/forum/pages/index/index.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title><core-format-text [text]="title"></core-format-text></ion-title>\n\n        <ion-buttons end>\n            <!-- The buttons defined by the component will be added in here. -->\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n<addon-mod-forum-index [module]="module" [courseId]="courseId" (dataRetrieved)="updateData($event)"></addon-mod-forum-index>\n'/*ion-inline-end:"/var/www/html/apps/bajajauto/src/addon/mod/forum/pages/index/index.html"*/,
        }),
